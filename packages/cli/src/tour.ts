  ...
  children: [
    ...
    },
    {
      ...
      children: [
        ...
        { kind: "bullet", text: "Two view buttons up top: Compact mode shortens every row to a one-line label (your text is untouched — it returns when you edit), and Filters hides items by who created them and who they're assigned to. Anything with work beneath it shows a progress bar, and every row carries how long ago it was created — hover for the exact time" },
        { kind: "bullet", text: "Agents claim a task with kalamu start before working on it, so a second session can't take it — a claimed task shows ▶ in its checkbox. Real dependencies go in the data: Block on… in the palette (kalamu block) keeps a task or discussion out of the queue until its blocker is done" },
      ],
    },
