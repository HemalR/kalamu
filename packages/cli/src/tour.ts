  ...
  children: [
    ...
    },
    {
      ...
      children: [
        ...
        { kind: "bullet", text: "A repo-relative path ending in .md, typed anywhere in an item's text, renders as a doc chip — click it to open that file read-only" },
