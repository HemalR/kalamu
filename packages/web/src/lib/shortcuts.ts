...
export const SHORTCUTS = {
  ...
  numberItem: { keys: "1. ", does: "At the start of the text: make the item a numbered list entry (Enter continues the list)" },
  clearPriority: { keys: "Backspace", does: "At the start of the text: clear the item's priority, then its list number" },
  ...
  copyContext: { combo: { key: "c", mod: true }, keys: "Mod+C", does: "Copy item context for an agent chat (when nothing is selected)" },
  copyText: { combo: { key: "c", mod: true, shift: true }, keys: "Mod+Shift+C", does: "Copy only the item's text" },
